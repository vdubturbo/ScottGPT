-- ============================================
-- COMPLETE FIX FOR PGVECTOR SEARCH (v3)
-- ============================================
-- Issues fixed:
...
-- 4. Date type casting - convert dates to text in SELECT
-- ============================================
...
RETURNS TABLE(
  ...
  skills TEXT[],
  tags TEXT[],
  date_start TEXT,  -- Return as TEXT
  date_end TEXT,    -- Return as TEXT
  similarity FLOAT,
  source_type TEXT,
  source_title TEXT,
  source_org TEXT,
...
BEGIN
  ...
  SELECT 
    ...
    cc.skills,
    cc.tags,
    cc.date_start::TEXT,  -- Cast date to TEXT for return
    cc.date_end::TEXT,    -- Cast date to TEXT for return
